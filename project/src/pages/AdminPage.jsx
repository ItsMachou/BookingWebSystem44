        ...
        <div className="w-full md:w-1/2">
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-2 rounded-lg transition duration-200 ease-in-out">
                Create Account
              </button>
              <button className="bg-red-500 hover:bg-red-600 text-white font-semibold px-6 py-2 rounded-lg transition duration-200 ease-in-out">
                Delete Account
              </button>
            </div>
          </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-blue-600 text-white">
                {["Username", "Password"].map((header, idx) => (
